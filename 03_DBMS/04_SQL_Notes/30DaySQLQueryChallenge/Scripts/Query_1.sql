...
SELECT *,
CASE WHEN brand1 < brand2 THEN CONCAT(brand1, brand2, 'year') ELSE CONCAT(brand2, brand1, 'year') END AS pair2,
CASE WHEN (custom1 <> custom3 OR custom2 <> custom4) THEN 'True' ELSE 'False' END AS customValueCheck
FROM brands
